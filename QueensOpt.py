import mlrose_hiive
from mlrose_hiive import Queens, FlipFlop, Queens
...
def runQueensOpt(length=15):
    ...
    # This will be the Queens Optimization Problem
    fitness = Queens()
    ...
    print("Running Performance Experiment for Queens \n")
    ...
    agg_data_df.to_csv('./results/{}_{}.csv'.format('Queens', length))
    print("Saved aggregate for Queens \n")
    ...
    plt.title('Score vs Iterations for RO algorithims.  Problem: {}'.format("Queens"))
    plt.xlabel("Iterations")
    plt.ylabel("Best Fitness Value")
    plt.legend()
    plt.savefig('./graphs/{}_{}.png'.format("Queens_Performance", length))
    ...
    print("Running RHC Exp for Queens \n")
    ...
    plt.title('Restarts vs Best Score.  Problem: {}'.format("Queens"))
    plt.xlabel("Num Restarts")
    plt.ylabel("Best Fitness Value")
    plt.legend()
    plt.savefig('./graphs/{}_{}.png'.format("Queens_RHC_Restart", length))   


    print("Running SA Exp for Queens \n")
    ...
    plt.title('Decay Rate vs Final Score.  Problem: {}'.format("Queens"))
    plt.xlabel("Decay Rate")
    plt.ylabel("Best Fitness Value")
    plt.legend()
    plt.savefig('./graphs/{}_{}.png'.format("Queens_SA_Decay", length))        


    # Conduct a study of parameter variation for GA and MIMIC

    print("Running GA/MIMIC Exp for Queens \n")
    ...
    plt.title('Pop Size vs Final Score.  Problem: {}'.format("Queens"))
    plt.xlabel("Decay Rate")
    plt.ylabel("Best Fitness Value")
    plt.legend()
    plt.savefig('./graphs/{}_{}.png'.format("Queens_PopSize", length))  

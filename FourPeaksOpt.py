import mlrose_hiive
from mlrose_hiive import FourPeaks, FlipFlop, Queens
...
def runFourPeaksOpt(length=50):
    ...
    # This will be the Four Peaks Optimization Problem
    ...
    print("Running Performance Experiment for Four Peaks \n")
    ...
    agg_data_df.to_csv('./results/{}_{}.csv'.format('FourPeaks', length))
    print("Saved aggregate for Four Peaks \n")
    ...
    plt.title('Score vs Iterations for RO algorithims.  Problem: {}'.format("FourPeaks"))
    plt.xlabel("Iterations")
    plt.ylabel("Best Fitness Value")
    plt.legend()
    plt.savefig('./graphs/{}_{}.png'.format("FourPeaks_Performance", length))
    ...
    print("Running RHC Exp for Four Peaks \n")
    ...
    plt.title('Restarts vs Best Score.  Problem: {}'.format("FourPeaks"))
    plt.xlabel("Num Restarts")
    plt.ylabel("Best Fitness Value")
    plt.legend()
    plt.savefig('./graphs/{}_{}.png'.format("FourPeaks_RHC_Restart", length))   


    print("Running SA Exp for Four Peaks \n")
    ...
    plt.title('Decay Rate vs Final Score.  Problem: {}'.format("FourPeaks"))
    plt.xlabel("Decay Rate")
    plt.ylabel("Best Fitness Value")
    plt.legend()
    plt.savefig('./graphs/{}_{}.png'.format("FourPeaks_SA_Decay", length))        


    # Conduct a study of parameter variation for GA and MIMIC

    print("Running GA/MIMIC Exp for Four Peaks \n")
    ...
    plt.title('Pop Size vs Final Score.  Problem: {}'.format("FourPeaks"))
    plt.xlabel("Decay Rate")
    plt.ylabel("Best Fitness Value")
    plt.legend()
    plt.savefig('./graphs/{}_{}.png'.format("FourPeaks_PopSize", length))  

    print("All Four Peaks Experiments Complete. Results saved.")
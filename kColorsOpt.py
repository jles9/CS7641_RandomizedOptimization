import mlrose_hiive
from mlrose_hiive import MaxKColor
...
def runkColorsOpt(length=50):
    
    #length = 7 # number of edges
    ...
    sa_params["decay_rate"] = 0.005 # Kept constant
    ...
    print("Running Performance Experiment for kColors \n")
    ...
    agg_data_df.to_csv('./results/{}_{}.csv'.format('kColors', length))
    print("Saved aggregate for kColors \n")
    ...
    plt.title('Score vs Iterations for RO algorithims.  Problem: {}'.format("kColors"))
    plt.xlabel("Iterations")
    plt.ylabel("Best Fitness Value")
    plt.legend()
    plt.savefig('./graphs/{}_{}.png'.format("kColors_Performance", length))
    ...
    print("Running RHC Exp for kColors \n")
    ...
    plt.title('Restarts vs Best Score.  Problem: {}'.format("kColors"))
    plt.xlabel("Num Restarts")
    plt.ylabel("Best Fitness Value")
    plt.legend()
    plt.savefig('./graphs/{}_{}.png'.format("kColors_RHC_Restart", length))   


    print("Running SA Exp for kColors \n")
    ...
    plt.title('Decay Rate vs Final Score.  Problem: {}'.format("kColors"))
    plt.xlabel("Decay Rate")
    plt.ylabel("Best Fitness Value")
    plt.legend()
    plt.savefig('./graphs/{}_{}.png'.format("kColors_SA_Decay", length))        


    # Conduct a study of parameter variation for GA and MIMIC

    print("Running GA/MIMIC Exp for kColors \n")
    ...
    plt.title('Pop Size vs Final Score.  Problem: {}'.format("kColors"))
    plt.xlabel("Decay Rate")
    plt.ylabel("Best Fitness Value")
    plt.legend()
    plt.savefig('./graphs/{}_{}.png'.format("kColors_PopSize", length))  

    print("All kColors Experiments Complete. Results saved.")
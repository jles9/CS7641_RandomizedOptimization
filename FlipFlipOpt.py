...
def runFlipFlopOpt(length=50):
    ...
    # This will be the Flip Flop Optimization Problem
    fitness = FlipFlop()
    ...
    print("Running Performance Experiment for Flip Flop \n")
    ...
    agg_data_df.to_csv('./results/{}_{}.csv'.format('FlipFlop', length))
    print("Saved aggregate for Flip Flop \n")
    ...
    plt.title('Score vs Iterations for RO algorithims.  Problem: {}'.format("FlipFlop"))
    plt.xlabel("Iterations")
    plt.ylabel("Best Fitness Value")
    plt.legend()
    plt.savefig('./graphs/{}_{}.png'.format("FlipFlop_Performance", length))
    ...
    print("Running RHC Exp for Flip Flop \n")
    ...
    plt.title('Restarts vs Best Score.  Problem: {}'.format("FlipFlop"))
    plt.xlabel("Num Restarts")
    plt.ylabel("Best Fitness Value")
    plt.legend()
    plt.savefig('./graphs/{}_{}.png'.format("FlipFlop_RHC_Restart", length))   


    print("Running SA Exp for Flip Flop \n")
    ...
    plt.title('Decay Rate vs Final Score.  Problem: {}'.format("FlipFlop"))
    plt.xlabel("Decay Rate")
    plt.ylabel("Best Fitness Value")
    plt.legend()
    plt.savefig('./graphs/{}_{}.png'.format("FlipFlop_SA_Decay", length))        


    # Conduct a study of parameter variation for GA and MIMIC

    print("Running GA/MIMIC Exp for Flip Flop \n")
    ...
    print("All Flip Flop Experiments Complete. Results saved.")